...
public class MainView extends View
{
    ...
    protected void onSizeChanged(int width, int height, int oldw, int oldh)
    {
        ...
        Util.debugLog("MainView.onSizeChanged");
    ...
    private void drawDrawable(Canvas canvas, Drawable draw, int startingX, int startingY,
    ...
    private void drawScoreText(Canvas canvas)
    {
        ...
        int textWidthHighScore = Math.max(titleWidthHighScore, bodyWidthHighScore)
                + textPaddingSize * 2;
    ...
    private void drawNewGameButton(Canvas canvas, boolean lightUp)
    {
        if (lightUp)
        {
            drawDrawable(canvas, lightUpRectangle, sXNewGame, sYIcons, sXNewGame + iconSize,
                         sYIcons + iconSize);
        }
        else
        {
            drawDrawable(canvas, backgroundRectangle, sXNewGame, sYIcons, sXNewGame + iconSize,
                         sYIcons + iconSize);
        }
        // 画开始按钮上面的refresh drawable
    ...
    private void drawHeader(Canvas canvas)
    {
        ...
        Util.debugLog("MainView.drawHeader " + " textShiftY " + textShiftY + " headerStartY "
                + headerStartY + " startingX " + startingX);
    ...
    private void drawBackground(Canvas canvas)
    {
        ...
        Util.debugLog("MainView.drawBackground " + "startingX " + startingX + " startingY "
                + startingY + " endingX " + endingX + " endingY " + endingY);
    }
                    ...
                    for (int i = aArray.size() - 1; i >= 0; i--)
                    {
                        ...
                        { // Spawning
                          // animation
                            ...
                            bitmapCell[index].setBounds((int)(sX + cellScaleSize),
    ...
    private void createEndGameStates(Canvas canvas, boolean win, boolean showButton)
    {
        ...
        if (win)
        {
            ...
            canvas.drawText(text, middleX, textBottom + textPaddingSize * 2 - centerText() * 2,
                            paint);
        }
        else
        {
    ...
    {
        Util.debugLog("MainView.createBackgroundBitmap width " + width + " height " + height);
    ...
    {
        Util.debugLog("MainView.createBitmapCells ");
    ...
    /**
     * 初始化所有的overlay界面 获胜继续， 获得最终胜利， 失败
     */
    ...
    {
        Util.debugLog("MainView.getLayout " + "width " + width + " height " + height);
        ...
        Util.debugLog("gridWidth " + gridWidth + " boardMiddleX " + boardMiddleX + " boardMiddleY "
                + boardMiddleY + " iconSize " + iconSize);
        ...
        Util.debugLog("cellSize " + cellSize + " textSize " + textSize + " cellTextSize "
                + cellTextSize + " titleTextSize " + titleTextSize + " bodyTextSize "
                + bodyTextSize + " instructionsTextSize " + instructionsTextSize
                + " headerTextSize" + headerTextSize + " gameOverTextSize " + gameOverTextSize
                + " textPaddingSize " + textPaddingSize + " iconPaddingSize " + iconPaddingSize);
        ...
        Util.debugLog("startingX " + startingX + " startingY " + startingY + " endingX " + endingX
                + " endingY " + endingY);
    ...
    {
        super(context);
        Util.debugLog("MainView constructor ");
