...
public class MainGame
{
    ...
    private void spawnTile(Tile tile)
    {
        ...
        aGrid.startAnimation(tile.getX(), tile.getY(), SPAWN_ANIMATION, SPAWN_ANIMATION_TIME,
                             MOVE_ANIMATION_TIME, null); // Direction:
                                                         // -1 =
                                                         // EXPANDING
    }
                ...
                if (tile != null)
                {
                            ...
                            && next.getMergedFrom() == null)
                    {
                        ...
                        aGrid.startAnimation(merged.getX(), merged.getY(), MOVE_ANIMATION,
                                             MOVE_ANIMATION_TIME, 0, extras); // Direction:
                                                                              // 0
                                                                              // =
                                                                              // MOVING
                                                                              // MERGED
    ...
    /**
     * TraversalX 遍历 只有向右移动，返回3,2,1,0 其余都是返回 0，1，2，3
     * 
     * @param vector
     * @return
     */
    private List<Integer> buildTraversalsX(Cell vector)
    {
        ...
        Util.debugLog("MainGame.buildTraversalesX " + traversals.toString());
        return traversals;
    }

    /**
     * TraversalY 遍历 只有向下移动，返回3,2,1,0 其余都是返回 0，1，2，3
     * 
     * @param vector
     * @return
     */
    private List<Integer> buildTraversalsY(Cell vector)
    {
        ...
        Util.debugLog("MainGame.buildTraversalesY " + traversals.toString());
        return traversals;
    }
